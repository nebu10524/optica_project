...
<head>
    ...
    <style>
        ...
        .brand-block .cell { display: table-cell; vertical-align: middle; padding-right: 12px; }
        ...
        .patient td, .patient th { border: 1px solid #e2e8f0; padding: 6px 8px; text-align: left; }
...
<table class="patient">
    ...
    <tr>
        <th class="h" scope="row">Fecha análisis</th>
...
<div class="two-col">
    <div class="col card">
        ...
        <div class="img-wrap">
            @if($imagenBase64)
                <img src="{{ $imagenBase64 }}" alt="Retinografia">
            @else
